...
Platform grass = Platform(true, 220.f, 50.f, -10, 400, sf::Color(0, 128, 0));
...
Character player = Character(playerWidth, 50.f, 20, 300, "../src/beachball.png");
Character altPlayer1 = Character(50.f, 50.f, 20, 300, "../src/beachball.png"); //change to sprite/picture only
Character altPlayer2 = Character(50.f, 50.f, 20, 300, "../src/beachball.png"); //change to sprite/picture only
Character altPlayer3 = Character(50.f, 50.f, 20, 300, "../src/beachball.png"); //change to sprite/picture only
Character altPlayer4 = Character(50.f, 50.f, 20, 300, "../src/beachball.png"); //change to sprite/picture only
...
Spawnpoint spawnpoint1 = Spawnpoint(20, 300);
...
void GameManager::renderWorldObjects(sf::RenderWindow* window, int numberOfClients, int selfId, int clientId1, float xpos1, float ypos1, int clientId2, float xpos2, float ypos2, int clientId3, float xpos3, float ypos3, int clientId4, float xpos4, float ypos4){
    ...
    //draws grass, moving platform, and player
    window->draw(grass);
    ...
    if (eventManager->checkForDeathEvent(&player, &dzone)){
...
bool GameManager::takeInput(sf::RenderWindow* window){
    ...
    int gravScale = physEngine->gravityFuntion(player.getGroundedTime(), last_time);
    //press up to move up
    if(gravScale != 4 && sf::Keyboard::isKeyPressed(sf::Keyboard::Up)){
        //movement now being handled by input event
        //player.move(0,-4 * movementDelta);
        inputRead = true;
        //the index of inputbools is determined by the order of if statements
        inputBools[2] = 1;
